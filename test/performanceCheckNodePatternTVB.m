...
%    nnnueRf = figure;
    ...
    for k=1:N
        ...
        title(['ROC curve of GC (pat=' num2str(i) ')']);
%%{
...
%%}
    ...
    disp(['GC AUC (' num2str(i) ', node=' num2str(node_num) ', density=' num2str(density) ') : ' num2str(mean(gcAUC))]);
    ...
    save(fname, 'fcAUC','gcAUC','dlAUC','rnnAUC','linueAUC','nnnueAUC', 'fcROC','gcROC','dlROC','rnnROC','linueROC','nnnueROC');
end
