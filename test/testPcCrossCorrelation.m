...
function testPcCrossCorrelation
    % load signals
    ...
    figure; [NCC, lags] = plotPcPartialCrossCorrelation(si, exSignal, [], exControl, 5);
    figure; [NCC, lags] = plotPcPartialCrossCorrelation(si, exSignal, [], exControl, 5, 0.8);
    ...
    figure; [NCC, lags] = plotPcPartialCrossCorrelation(si, exSignal, [], exControl, 5, 0.99, 1);
    figure; [NCC, lags] = plotPcPartialCrossCorrelation(si, exSignal, [], exControl, 5, 0.8, 1);
    ...
    figure; [PNCC1, lags] = plotPcPartialCrossCorrelation(S(:,:,1), [], [], [], 5);
    figure; [PNCC2, lags] = plotPcPartialCrossCorrelation(S(:,:,2), [], [], [], 5);
    PNCC1(:,:,6)=[]; PNCC2(:,:,6)=[];
