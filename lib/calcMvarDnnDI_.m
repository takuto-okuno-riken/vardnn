%%
% Calculate multivariate VAR DNN Directional Influence matrix (DI) and impaired node signals (DIsub)
...
function [DI, DIsub] = calcMvarDnnDI_(net, nodeControl, exControl, isFullNode)
