...
function [gcI, h, P, F, cvFd, AIC, BIC, nodeAIC, nodeBIC] = plotMultivariateGCI(X, exSignal, nodeControl, exControl, lags, range, alpha, isFullNode)
    ...
    [gcI, h, P, F, cvFd, AIC, BIC, nodeAIC, nodeBIC] = calcMultivariateGCI(X, exSignal, nodeControl, exControl, lags, alpha, isFullNode);
    if range <= 0
