...
function net = initDlcmNetwork(X, inSignal, inControl, initWeightFunc, initBias)
    if nargin < 5, initBias = 0; end
    ...
    % layer parameters
    net = createDlcmNetwork(nodeNum, inputNum, hiddenNums, inControl, initWeightFunc, biasMat);
end