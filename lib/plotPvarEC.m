...
function [EC, ECsub] = plotPvarEC(X, exSignal, nodeControl, exControl, lags, range, isFullNode)
    ...
    [EC, ECsub] = calcPvarEC(X, exSignal, nodeControl, exControl, lags, isFullNode);
    if range <= 0
