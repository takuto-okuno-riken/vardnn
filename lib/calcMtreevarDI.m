...
function [DI, DIsub] = calcMtreevarDI(net, nodeControl, exControl, isFullNode)
    ...
    for i=1:nodeNum
        ...
        % predict 
        DIsub(i,1) = predict(net.trees{i}, nodeInput.');
        ...
        for j=1:nodeMax
            ...
            % predict 
            DIsub(i,j+1) = predict(net.trees{i}, nodeInput.');
