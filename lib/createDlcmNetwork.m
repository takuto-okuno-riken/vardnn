...
function net = createDlcmNetwork(nodeNum, inputNum, hiddenNums, inControl, initWeightFunc, initWeightParam, initBias)
    if nargin < 7, initBias = zeros(hiddenNums(1),1); end
    ...
    for i=1:nodeNum
        ...
        nodeLayers{i} = createDlcmLayers(nodeNum, inputNum, hiddenNums, nodeInControl, initWeightFunc, initWeightParam, initBias, i);
    end
