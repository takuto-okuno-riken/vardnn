...
function net = createDlcmNetwork(nodeNum, inputNum, hiddenNums, nodeControl, inControl, initWeightFunc, initWeightParam, initBias)
    ...
    for i=1:nodeNum
        ...
        nodeLayers{i} = createDlcmLayers(nodeNum, inputNum, hiddenNums, nNodeControl, nodeInControl, initWeightFunc, initWeightParam, initBias, i);
    end
