...
%            'Plots','training-progress');
    ...
    [S, t,mae,maeerr] = plotPredictSignals(si,[],[],netDLCM);
    disp(['t=' num2str(t) ', mae=' num2str(mae)]);
    ...
    dlEC = plotDlcmECmeanAbsWeight(netDLCM);
    dlEC = plotDlcmECmeanDeltaWeight(netDLCM);
    dlEC = plotDlcmECmeanAbsDeltaWeight(netDLCM);
